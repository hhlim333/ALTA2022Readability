...
if model_name.lower() == 'chinese-roberta-wwm-ext':
...
elif model_name.lower() == 'chinese-xlnet-base':
...
elif model_name.lower() == 'chinese-xlnet-mid':
    tokenizer = XLNetTokenizer.from_pretrained('chinese-xlnet-mid')
    model = XLNetForSequenceClassification.from_pretrained(args.checkpoint_path)

elif model_name.lower() == 'chinese-bert-wwm':
    tokenizer = BertTokenizer.from_pretrained('chinese-bert-wwm')
    model = BertForSequenceClassification.from_pretrained(args.checkpoint_path)

elif model_name.lower() == 'chinese-roberta-wwm-ext-large':
    tokenizer = BertTokenizer.from_pretrained('chinese-roberta-wwm-ext-large')
    model = BertForSequenceClassification.from_pretrained(args.checkpoint_path)

elif model_name.lower() == 'chinese-macbert-large':
    tokenizer = BertTokenizer.from_pretrained('chinese-macbert-large')
    model = BertForSequenceClassification.from_pretrained(args.checkpoint_path)
