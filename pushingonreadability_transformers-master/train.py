...
elif args.model.lower() == 'chinese-roberta-wwm-ext':
    tokenizer_class = BertTokenizer
    model_class = BertForSequenceClassification
    pretrained_model_name = 'chinese-roberta-wwm-ext'

elif args.model.lower() == 'chinese-bert-wwm':
    tokenizer_class = BertTokenizer
    model_class = BertForSequenceClassification
    pretrained_model_name = 'chinese-bert-wwm'
...
elif args.model.lower() == 'bart-base-chinese':
    tokenizer_class = BertTokenizer
    model_class = BertForSequenceClassification
    pretrained_model_name = 'bart-base-chinese'

elif args.model.lower() == 'chinese-pert-base':
    tokenizer_class = BertTokenizer
    model_class = BertForSequenceClassification
    pretrained_model_name = 'chinese-pert-base'


elif args.model.lower() == 'chinese-pert-large':
    tokenizer_class = BertTokenizer
    model_class = BertForSequenceClassification
    pretrained_model_name = 'chinese-pert-large'
