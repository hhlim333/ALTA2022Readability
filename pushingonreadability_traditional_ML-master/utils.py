...
def prepare_classification_data(df: pd.DataFrame,neural_models_to_use,this_handcrafted_features_list):
    ...
    if neural_models_to_use == "none":
        ...
        for neural_model in neural_models_to_use:
            this_neural_model_list.append(neural_model+".14.pred")
        '''
        '''
        lst = range(0,768)
        this_neural_model_list=["{:1d}".format(x) for x in lst]
        '''
        this_neural_model_list = []
        for neural_model in neural_models_to_use:
            ...
            this_neural_model_list.append(neural_model+".14.prob.6")
            this_neural_model_list.append(neural_model+".14.prob.7")
            this_neural_model_list.append(neural_model+".14.prob.8")
            this_neural_model_list.append(neural_model+".14.prob.9")
            this_neural_model_list.append(neural_model+".14.prob.10")
            this_neural_model_list.append(neural_model+".14.prob.11")
            this_neural_model_list.append(neural_model+".14.prob.12")
        '''
        for neural_model in neural_models_to_use:
        ...
        '''
        active_features =this_neural_model_list+this_handcrafted_features_list
        #active_features =this_neural_model_list
        #active_features =this_handcrafted_features_list
